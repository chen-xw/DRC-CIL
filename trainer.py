...
def _train(args):
    ...
    logging.info('CNN top1 average accuracy: {}'.format(sum(cnn_curve['top1'])/len(cnn_curve['top1'])))
    logging.info('CNN top5 average accuracy: {}'.format(sum(cnn_curve['top5'])/len(cnn_curve['top5'])))
